...
class Mo_API_Authentication_Admin_Config {
	...
	if(base64_decode(get_option('miniorange_api_authentication_ctr'))>=100)
	{
		$mo_api_disable=1;
	}
	?>	
			...
			<div>
				...
				<form method="post" id="mo-authentication-method-form" action="">
					...
					<div class="mo_api_authentication_settings_table">
						...
						<?php if(base64_decode(get_option('miniorange_api_authentication_ctr'))==100){ ?>
						<div style="text-align:center;">
							<input type="hidden" name="action" id="mo_api_auth_save_config_input" value="Save Configuration">
							<button type="button" style="margin:15px; width:170px;" onclick="moAuthenticationMethodSave('Reset')" class="button button-primary button-large" disabled>Reset</button>
							<button type="submit" style="margin:15px; width:170px;" onclick="moAuthenticationMethodSave('Save Configuration')" id="mo_api_auth_save_config_button" class="button button-primary button-large" disabled>Save Configuration</button>
						</div>
					<?php }else{?>
							<div style="text-align:center;">
							<input type="hidden" name="action" id="mo_api_auth_save_config_input" value="Save Configuration">
